...
func evalWhileExpression(we *ast.WhileExpression, env *object.Environment) object.Object {
	...
	for {
		...
		// If there's a return inside while, we should probably handle it,
		// but for now let's just loop.
		// Note: The current evalBlockStatement returns ReturnValue if found.
		// We should check for it here if we want to support return from inside while loops properly.
